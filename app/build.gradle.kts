...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 36
        versionCode = providers.gradleProperty("XYPRT_VERSION_CODE").orElse("1030011").get().toInt()
        versionName = providers.gradleProperty("XYPRT_VERSION_NAME").orElse("1.3.0").get()
